      ...
      >
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          <div style={{
            ...
            <Title level={2} style={{ color: '#161616', marginBottom: '8px' }}>Create Interviewee Account</Title>
          ...
          <div style={{ textAlign: 'center', paddingTop: '16px', borderTop: '1px solid #e0e0e0' }}>
            ...
            <Link to="/login/interviewee" style={{ color: '#0f62fe', fontWeight: '600' }}>Sign In</Link>
          </div>
        </Space>
      </Card>
    </div>
